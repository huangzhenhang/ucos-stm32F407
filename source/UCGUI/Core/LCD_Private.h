...
const tLCDDEV_APIList* LCD_SetAPI(const tLCDDEV_APIList* pAPI, int Index);
  ...
  #define LCD_BKCOLORINDEX GUI_Context.LCD_gui.aColorIndex8[0]
  #define LCD_COLORINDEX   GUI_Context.LCD_gui.aColorIndex8[1]
  #define LCD_ACOLORINDEX  GUI_Context.LCD_gui.aColorIndex8
#else
  #define LCD_BKCOLORINDEX GUI_Context.LCD_gui.aColorIndex16[0]
  #define LCD_COLORINDEX   GUI_Context.LCD_gui.aColorIndex16[1]
  #define LCD_ACOLORINDEX  GUI_Context.LCD_gui.aColorIndex16
#endif
